...
def align_multiple_map_networks(Gs, cost_params, similarity_tuples=None,
    ...
    # Sofiane: I have commented this out as I don't have a way to evaluate - No Ground Truth.
